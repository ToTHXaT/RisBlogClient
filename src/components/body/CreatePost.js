                    ...
                    {tags ?
                        tags.sort().map((tag, i) =>
                            <Col>
                                <div
                                    key={i}
                                    className="text-primary text-center user-select-none"
                                    onClick={(e) => {
                ...
                <Row>
                    <Col>
                        <InputGroup className="mt-4 mb-4">
                            ...
                            <FormControl as="textarea" rows="18" aria-label="With textarea" ref={_content}/>
                        </InputGroup>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col sm={{span: 2, offset: 5}} className="mb-4">
                        <Button variant="primary" type="button" onClick={() => {
                            ...
                            (async () => {
                                let ans = await ArticleManager.createArticle(title, content, tags)
